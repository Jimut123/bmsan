...
def saveModel(model):
    ...
    fp = open('models/modelP_UNet_skinleison.json','w')
    fp.write(model_json)
    model.save_weights('models/modelW_UNet_skinleison.h5')
...
def evaluateModel(model, X_test, Y_test, batchSize):
    ...
    fp = open('models/log_UNet_skinleison.txt','a')
    fp.write(str(jacard)+'\n')
    fp.close()

    fp = open('models/best_UNet_skinleison.txt','r')
    best = fp.read()
    fp.close()
...
def trainStep(model, X_train, Y_train, X_test, Y_test, epochs, batchSize):
    ...
    # save to json:
    hist_json_file = 'history_UNet_skinleison.json'
    ...
    # or save to csv:
    hist_csv_file = 'history_UNet_skinleison.csv'
...
fp = open('models/log_UNet_skinleison.txt','w')
fp.close()
fp = open('models/best_UNet_skinleison.txt','w')
fp.write('-1.0')
