...
import sys
sys.path.insert(0, '../../')
from models import DRRMSAN_ablation_wo_minpool
...
for train_index, test_index in kf.split(X):
    ...
    alpha_3 = 0.25
    alpha_4 = 0.25
    model = DRRMSAN_ablation_wo_minpool(height=192, width=256, n_channels=3, alpha_1 = alpha_1, alpha_2 = alpha_2, alpha_3 = alpha_3, alpha_4 = alpha_4)
