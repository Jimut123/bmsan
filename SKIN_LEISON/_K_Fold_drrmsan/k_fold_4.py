...
for train_index, test_index in kf.split(X):
    ...
    def evaluateModel(model, X_test, Y_test, batchSize):
        ...
        with open("Output_4.txt", "a") as text_file:
    ...
    model = DRRMSAN_multiscale_attention_bayes_4(height=192, width=256, n_channels=3, alpha_1=0.20, alpha_2=0.20, alpha_3=0.20, alpha_4=0.20, alpha_5=0.20)
