...
for train_index, test_index in kf.split(X):
    ...
    def saveModel(model):
        ...
        fp = open('models/modelP_multi_res_unet_skinLesion.json','w')
        fp.write(model_json)
        model.save_weights('models/modelW_multi_res_unet_skinLesion.h5')
    ...
    def trainStep(model, X_train, Y_train, X_test, Y_test, epochs, batchSize):
        ...
        # save to json:
        hist_json_file = 'history_multi_res_unet_skinLesion_fold_{}.json'.format(fold_no)
        ...
        # or save to csv:
        hist_csv_file = 'history_multi_res_unet_skinLesion_fold_{}.csv'.format(fold_no)
