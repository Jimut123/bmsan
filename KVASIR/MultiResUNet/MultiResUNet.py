...
def saveModel(model):
    ...
    fp = open('models/modelP__multi_res_unet_kvasir.json','w')
    fp.write(model_json)
    model.save_weights('models/modelW__multi_res_unet_kvasir.h5')
...
def trainStep(model, X_train, Y_train, X_test, Y_test, epochs, batchSize):
    ...
    # save to json:
    hist_json_file = 'history_multi_res_unet_kvasir.json'
    ...
    # or save to csv:
    hist_csv_file = 'history_multi_res_unet_kvasir.csv'
