...
def saveModel(model):
    ...
    fp = open('models/modelP_attn_1_lung.json','w')
    fp.write(model_json)
    model.save_weights('models/modelW_attn_1_lung.h5')
...
def evaluateModel(model, X_test, Y_test, batchSize):
    ...
    fp = open('models/log_attn_1_lung.txt','a')
    fp.write(str(jacard)+'\n')
    fp.close()

    fp = open('models/best_attn_1_lung.txt','r')
    best = fp.read()
    fp.close()
    ...
    if(jacard>float(best)):
        ...
        print('***********************************************')
        fp = open('models/best_attn_1_lung.txt','w')
        fp.write(str(jacard))
        fp.close()
...
def trainStep(model, X_train, Y_train, X_test, Y_test, epochs, batchSize):
    ...
    # save to json:
    hist_json_file = 'history_attn_1_lung.json'
    ...
    # or save to csv:
    hist_csv_file = 'history_attn_1_lung.csv'
...
model = DRRMSAN_multiscale_attention_1(height=256, width=256, n_channels=3)
...
fp = open('models/log_attn_1_lung.txt','w')
fp.close()
fp = open('models/best_attn_1_lung.txt','w')
fp.write('-1.0')
fp.close()
