...
def saveModel(model):
    ...
    fp = open('models/modelP_MultiResUNet_Lung.json','w')
    fp.write(model_json)
    model.save_weights('models/modelW_MultiResUNet_Lung.h5')
...
def evaluateModel(model, X_test, Y_test, batchSize):
    ...
    fp = open('models/log_multi_res_unet_lungs.txt','a')
    fp.write(str(jacard)+'\n')
    fp.close()

    fp = open('models/best_multi_res_unet_lungs.txt','r')
    best = fp.read()
    fp.close()
...
def trainStep(model, X_train, Y_train, X_test, Y_test, epochs, batchSize):
    ...
    # save to json:
    hist_json_file = 'history_multi_res_unet_lungs.json'
    ...
    # or save to csv:
    hist_csv_file = 'history_multi_res_unet_lungs.csv'
...
fp = open('models/log_multi_res_unet_lungs.txt','w')
fp.close()
fp = open('models/best_multi_res_unet_lungs.txt','w')
fp.write('-1.0')
