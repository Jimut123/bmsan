...
def saveModel(model):
    ...
    fp = open('models/modelP_attn_unet_brainMRI.json','w')
    fp.write(model_json)
    model.save_weights('models/modelW_attn_unet_brainMRI.h5')
...
def evaluateModel(model, X_test, Y_test, batchSize):
    ...
    fp = open('models/log_attn_unet_brainMRI.txt','a')
    fp.write(str(jacard)+'\n')
    fp.close()

    fp = open('models/best_attn_unet_brainMRI.txt','r')
    best = fp.read()
    fp.close()
...
def trainStep(model, X_train, Y_train, X_test, Y_test, epochs, batchSize):
    ...
    # save to json:
    hist_json_file = 'history_attn_unet_brainMRI.json'
    ...
    # or save to csv:
    hist_csv_file = 'history_attn_unet_brainMRI.csv'
...
fp = open('models/log_attn_unet_brainMRI.txt','w')
fp.close()
fp = open('models/best_attn_unet_brainMRI.txt','w')
fp.write('-1.0')
fp.close()
