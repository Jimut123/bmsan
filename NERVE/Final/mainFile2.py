...
def load_data(path, split=0.2):
    ...
    images_list = img_files.copy()
    masks_list = msk_files.copy()
...
def evaluateModel(model, X_test, Y_test, batchSize):
    ...
    print("00"*50)
    f = open("./bayesian_opt_logs_2.txt", "a+")
...
def f(x):
    ...
    # save to json:
    hist_json_file = 'history_nerve_drrmsan.json'
    ...
    # or save to csv:
    hist_csv_file = 'history_nerve_drrmsan.csv'
    ...
    model.save_weights("nerve_drrmsan_150e.h5")
