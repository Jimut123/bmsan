...
def DRRMSAN_multiscale_attention_bayes_4(height, width, n_channels, alpha_1, alpha_2, alpha_3, alpha_4, alpha_5):
    '''
    ...
    out5 = Conv2D(1, (3, 3), activation='sigmoid', padding='same', name='side_5')(side5)
