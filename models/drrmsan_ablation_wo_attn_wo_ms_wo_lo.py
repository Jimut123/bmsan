...
def DRRMSAN_multiscale_wo_attn_wo_ms_wo_lo(height, width, n_channels, alpha_1, alpha_2, alpha_3, alpha_4):
    '''
    ...
    up7 = concatenate([Conv2DTranspose(32*4, (2, 2), strides=(2, 2), padding='same', name='up7')(mresblock6), mresblock3])
    ...
    up8 = concatenate([Conv2DTranspose(32*2, (2, 2), strides=(2, 2), padding='same', name='up8')(mresblock7), mresblock2])#,
    ...
    up9 = concatenate([Conv2DTranspose(32, (2, 2), strides=(2, 2), padding='same', name='up9')(mresblock8), mresblock1])#
