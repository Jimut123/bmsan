...
def DRRMSAN_multiscale_attention_bayes_022_conc_concat(height, width, n_channels, alpha_1, alpha_2, alpha_3, alpha_4):
    '''
    ...
    out9 = Conv2D(1, (3, 3), activation='sigmoid', padding='same', name='side_9')(mresblock9) 
    ...
    out10 = Conv2D(1, (3, 3), activation='sigmoid', padding='same', name='side_10')(concatenate([out6, out7, out8, out9]))
